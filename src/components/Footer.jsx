...
<footer id='contact' class="bg-[#F9F9F9] font-pops">
    <div class="container mx-auto w-full max-w-screen-xl p-4 py-6 lg:py-8">
      ...
      <div class="sm:flex sm:items-center sm:justify-between">
          <span class="text-sm text-gray-500 sm:text-center text-center dark:text-gray-400">© 2024 <a href="#" class="hover:underline">Tonmoy™</a>. All Rights Reserved.
          </span>
